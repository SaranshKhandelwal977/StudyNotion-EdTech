...
const CoursesTable = ({courses, setCourses, durationArray, setDurationArray}) => {
        ...
        <Table className="rounded-xl border border-richblack-800 ">
            <Thead>
                <Tr className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-2">
                    <Th className="flex-1 text-left text-sm font-medium uppercase text-richblack-100 sm:text-richblack-100">Courses</Th>
                        ...
                        courses.map((course) => (
                            <Tr key={course._id} className="flex gap-x-10 border-b border-richblack-800 px-6 py-8">
                                ...
                                <Td className="text-sm font-medium text-richblack-100">
                                    {
                                        durationArray.map((element) => (
                                            element.courseName === course.courseName && (<span>{element.totalcourseDuration}</span> )
                                        ))
                                    }
                                </Td>
